...
/**
 * Describes a alfresco object located in the alfresco repository.
 *
...
class AlfrescoExternalRepositoryObject extends ExternalRepositoryObject
{
    ...
    public static function get_empty()
    {
        if (empty(self :: $empty))
        {
            self :: $empty = new alfrescoExternalRepositoryObject();
        }
        return self :: $empty;
    }
    ...
    function get_content_data($export_format)
    {
        ...
        return alfrescoExternalRepositoryManagerConnector :: get_instance($external_repository)->download_external_repository_object($url);
    }
