 ...
 *
 */
class AlfrescoExternalRepositoryObjectDisplay extends ExternalRepositoryObjectDisplay {
    ...
    protected function format_datastream(alfresco_fs_datastream $ds) {

        $title = $ds->get_title();

        $image_url = Theme::get_image_path(alfrescoExternalRepositoryManager::get_namespace(alfrescoExternalRepositoryManager::REPOSITORY_TYPE)) . '/types/datastream.png';
    ...
    protected function get_import_datastream_url($dsID = false) {
        $object = $this->get_object();
        $parameters = array();
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY_MANAGER_ACTION] = alfrescoExternalRepositoryManager::ACTION_IMPORT_EXTERNAL_REPOSITORY;
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY_ID] = $object->get_id();
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY] = $object->get_external_repository_id();
        $parameters[alfrescoExternalRepositoryManager::PARAM_RENDERER] = Request::get(alfrescoExternalRepositoryManager::PARAM_RENDERER);
        ...
        if ($dsID) {
            $parameters[alfrescoExternalRepositoryManager::PARAM_DATASTREAM_ID] = $dsID;
        }
    ...
    protected function get_view_datastream_content_url($dsID) {
        ...
        $parameters[Application::PARAM_APPLICATION] = Request::get(Application::PARAM_APPLICATION);
        $parameters[Application::PARAM_ACTION] = Request::get(Application::PARAM_ACTION);
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY_MANAGER_ACTION] = alfrescoExternalRepositoryManager::ACTION_DOWNLOAD_EXTERNAL_REPOSITORY;
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY_ID] = $object->get_id();
        $parameters[alfrescoExternalRepositoryManager::PARAM_EXTERNAL_REPOSITORY] = $object->get_external_repository_id();
        $parameters[alfrescoExternalRepositoryManager::PARAM_RENDERER] = Request::get(alfrescoExternalRepositoryManager::PARAM_RENDERER);
        $parameters[alfrescoExternalRepositoryManager::PARAM_DATASTREAM_ID] = $dsID;
    ...
    protected function display_system_datastreams(alfrescoExternalRepositoryObject $object) {
