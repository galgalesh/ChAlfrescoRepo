...
/**
 * Manager of the alfresco repository action.
 *
...
class AlfrescoExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    function get_menu_items($parent = null)
    {
        ...
        if (is_array($parent))
        {
            ...
            else
            {
                ...
                if ($parent instanceof alfresco_fs_store)
                {
    ...
    function create_api_component($action = false, $application = null)
    {
        ...
        {
            require_once $file;
            $class = __NAMESPACE__ . '\alfresco' . ucfirst($this->get_api()) . Utilities :: underscores_to_camelcase($action) . 'Component';
