...
class AlfrescoExternalRepositoryManagerImporterComponent extends AlfrescoExternalRepositoryManager
{
    ...
    function import_external_repository_object($external_object)
    {
        if ($external_object->is_importable())
        {
            ...
            //$document->set_in_memory_file($this->get_external_repository_manager_connector()->download_external_repository_object($external_object, $export_format));
