...
require_once dirname(__FILE__) . '/flickr_external_repository_manager_connector.class.php';
...
class FlickrExternalRepositoryManager extends ExternalRepositoryManager
{
    ...
    {
        return Path :: get_common_extensions_path() . 'external_repository_manager/implementation/flickr/php/component/';
    }
