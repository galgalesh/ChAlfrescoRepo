...
class FlickrExternalRepositoryManagerConnector extends ExternalRepositoryManagerConnector
{
     ...
     * @return FlickrExternalRepositoryManagerConnector:
     */
    static function get_instance($instance_id)
    {
        if (! isset(self :: $instance[$instance_id]))
        {
            self :: $instance[$instance_id] = new FlickrExternalRepositoryManagerConnector($instance_id);
        }
