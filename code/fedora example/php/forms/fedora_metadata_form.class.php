...
class FedoraMetadataForm extends FormValidator
{
    ...
    {
        $buttons[] = $this->createElement('style_submit_button', 'submit', Translation :: get('Next') . ' >>', array(
                'class' => 'positive'));
    ...
    protected function build_body()
    {
        ...
        $this->addElement('text', $id = FedoraExternalRepositoryObject :: PROPERTY_TITLE, Translation :: get('Title'), array(
                "size" => "50"));
        ...
        $this->addElement('textarea', $id = FedoraExternalRepositoryObject :: PROPERTY_DESCRIPTION, Translation :: get('Description'), array(
                "rows" => "7",
                "cols" => "80"));
        $defaults[$id] = $this->default_description();

        $this->addElement('text', $key = FedoraExternalRepositoryObject :: PROPERTY_AUTHOR, Translation :: get('Author'), array(
                "size" => "50"));
    ...
    function addSubject()
    {
        ...
        $group[] = $this->createElement('text', $text, Translation :: get('Subject'), array(
                "size" => "50",
                'id' => $text,
                'readonly' => 'readonly',
                'onclick' => $onclick));
